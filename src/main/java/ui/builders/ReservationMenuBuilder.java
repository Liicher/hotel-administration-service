...
import ui.actions.reservationActions.ReservationAction;
...
public class ReservationMenuBuilder implements ChildBuilder {
    private Menu menu;
    private RootMenuBuilder rootMenuBuilder;
    private final Map<String, ReservationAction> actions;
    ...
    public void buildMenu() {
        menu = new Menu("--- RESERVATION MENU ---");
