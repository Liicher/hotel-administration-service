...
import ui.actions.guestActions.GuestAction;
...
public class GuestMenuBuilder implements ChildBuilder {
    private Menu menu;
    private RootMenuBuilder rootMenuBuilder;
    private final Map<String, GuestAction> actions;
